...
final class Version20190327153142 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE carpeta (id INT AUTO_INCREMENT NOT NULL, cliente_id INT DEFAULT NULL, formato_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, activa TINYINT(1) NOT NULL, año SMALLINT NOT NULL, INDEX IDX_334DA23DDE734E51 (cliente_id), INDEX IDX_334DA23D8D02887B (formato_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
