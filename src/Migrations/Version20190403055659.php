 ...
 */
final class Version20190403055659 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE trabajo (id INT AUTO_INCREMENT NOT NULL, idpedido INT DEFAULT NULL, s_path_paletiza VARCHAR(255) DEFAULT NULL, s_trabajo VARCHAR(127) NOT NULL, i_unidades INT NOT NULL, s_cod_art VARCHAR(31) DEFAULT NULL, s_orden_de_compra VARCHAR(63) DEFAULT NULL, mt_notas LONGTEXT DEFAULT NULL, i_finalizado TINYINT(1) DEFAULT \'0\', s_tipo_palet VARCHAR(127) DEFAULT NULL, i_en2pal TINYINT(1) DEFAULT \'0\', i_en_cajas SMALLINT DEFAULT 0 NOT NULL, s_for_ban VARCHAR(127) DEFAULT NULL, s_separadores VARCHAR(127) DEFAULT NULL, s_apilado VARCHAR(127) DEFAULT NULL, i_uds_planta INT DEFAULT 0, i_plantas_par SMALLINT DEFAULT 0 NOT NULL, i_plantas_impar SMALLINT DEFAULT 0 NOT NULL, i_peso_par SMALLINT DEFAULT 0 NOT NULL, i_peso_impar SMALLINT DEFAULT 0 NOT NULL, i_cantoneras TINYINT(1) DEFAULT \'0\' NOT NULL, i_tapado TINYINT(1) DEFAULT \'0\' NOT NULL, i_alt_par SMALLINT DEFAULT 0 NOT NULL, i_alt_impar SMALLINT DEFAULT 0 NOT NULL, mt_otros_gra LONGTEXT DEFAULT NULL, s_dimension_caja VARCHAR(127) DEFAULT NULL, i_uds_caja SMALLINT DEFAULT 0 NOT NULL, i_cajas_planta SMALLINT DEFAULT 0 NOT NULL, mt_otros_caj LONGTEXT DEFAULT NULL, s_dir1 VARCHAR(127) DEFAULT NULL, s_dir2 VARCHAR(127) DEFAULT NULL, s_dir3 VARCHAR(127) DEFAULT NULL, s_dir4 VARCHAR(127) DEFAULT NULL, s_dir5 VARCHAR(127) DEFAULT NULL, s_dir6 VARCHAR(127) DEFAULT NULL, i_eti_x_caja TINYINT(1) DEFAULT \'0\' NOT NULL, n_kg_x_caja SMALLINT DEFAULT 0 NOT NULL, i_eti_defecto SMALLINT DEFAULT 1 NOT NULL, i_activo TINYINT(1) DEFAULT \'1\' NOT NULL, i_lote TINYINT(1) DEFAULT \'0\' NOT NULL, idsemi_pedido INT DEFAULT 0 NOT NULL, n_peso_palet DOUBLE PRECISION DEFAULT \'0\' NOT NULL, valor DOUBLE PRECISION DEFAULT \'0\' NOT NULL, i_extranjero TINYINT(1) DEFAULT \'0\' NOT NULL, manod DOUBLE PRECISION DEFAULT \'0\' NOT NULL, venta DOUBLE PRECISION DEFAULT \'0\' NOT NULL, t_changed DATETIME DEFAULT NULL, i_changed INT DEFAULT 0 NOT NULL, t_added DATETIME DEFAULT NULL, i_added INT DEFAULT 0 NOT NULL, id_anterior INT DEFAULT NULL, UNIQUE INDEX UNIQ_FDD6B80AE90EEC4B (id_anterior), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
